...
const heroImages = [
  "/images/ind-plastics.jpg",
  "/images/timeline-expansion.jpg",
  "/images/company-plastics.jpg",
];

export function RRPlasticsHero() {
    ...
    <section className="relative h-screen min-h-[700px] overflow-hidden">
      ...
      {heroImages.map((image, index) => (
        ...
        >
          <Image
            src={image}
            alt="RRPlastics Industries Operations"
            fill
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          <img
            ...
            alt="RRPlastics Industries Logo"
        ...
        >
          Distribution of plastic polymer, Manufacturing PET Preforms and HDPE
          Caps
        </p>
      </div>
